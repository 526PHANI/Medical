...
export default function PurchaseHistoryDashboard() {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      data.forEach(record => {
        const phone = String(record.phone || ""); // Normalize phone to string
        const name = record.name || "Unknown"; // Fallback for missing name
        ...
        customer.purchases.push({
          ...
          medicine: record.medicine || "Unknown", // Fallback for missing medicine
      ...
      console.log("Transformed Customers:", sortedCustomers); // Debug: Log transformed customers
      
      setCustomers(sortedCustomers);
      setFilteredCustomers(sortedCustomers);
    } catch (err: any) {
      console.error("Failed to fetch data:", err.message);
      toast.error(`Failed to load purchase history ( Please check your network ): ${err.message}`);
    } finally {
      setIsLoading(false);
    }
  };
  ...
  useEffect(() => {
    ...
    console.log("Filtered Customers:", results); // Debug: Log filtered results
        ...
        >
          ...
          <p className="mt-2 text-gray-500">
            {searchQuery 
              ...
              : "No purchase records available yet"}
          </p>
          <button
                  ...
                  {selectedCustomer?.id === customer.id && (
                    ...
                    >
                      <div className="p-6 pt-0">
                        <h4 className="text-sm font-semibold text-gray-500 uppercase tracking-wider mb-4">Purchase History</h4>
